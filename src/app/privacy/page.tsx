...
export const metadata: Metadata = {
  title: 'Política de Privacidade | Fluência Autodidata',
  description: 'Política de privacidade do Fluência Autodidata.',
};
    ...
    <div className="min-h-screen bg-[#0B1220] text-slate-300 font-sans p-8">
      <div className="max-w-3xl mx-auto bg-[#071426] p-8 md:p-12 rounded-3xl border border-white/10 shadow-2xl">
        ...
        <div className="space-y-6 text-sm leading-relaxed text-slate-400">
          ...
          <p>
            Se você tiver alguma dúvida sobre como lidamos com dados do usuário e informações pessoais, sinta-se à vontade para entrar em contato conosco através do email: suporte@vivimoraiss.com.
          </p>
        </div>
      </div>
    </div>
