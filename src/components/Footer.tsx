    ...
    <footer className="py-12 bg-[#071426] border-t border-white/5 text-center">
      <div className="container mx-auto px-6 flex flex-col items-center">
        <div className="flex gap-6 mb-8">
          <a href="https://www.instagram.com/vivimoraiss/" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-[#FFB800] transition-colors" aria-label="Instagram">
          ...
          <a href="https://www.tiktok.com/@vivimoraiss" className="text-slate-400 hover:text-[#FFB800] transition-colors" aria-label="TikTok">
            <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="https://www.linkedin.com/in/vivimoraiss/" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-[#FFB800] transition-colors" aria-label="LinkedIn">
            <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="mb-8">
          ...
          <a href="mailto:suporte@vivimoraiss.com" className="text-[#FFB800] hover:text-[#E6A600] transition-colors font-medium text-lg">
            suporte@vivimoraiss.com
          </a>
        </div>
        ...
        <p className="text-slate-600 text-sm font-medium">
          © {new Date().getFullYear()} Vivi Moraiss. Todos os direitos reservados.
        </p>
      </div>
    </footer>
  );
